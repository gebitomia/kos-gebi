...
<section class="hero-section">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
				<div class="hero-text">
					<h1>Kost Bapa Dede</h1>
					<p>Berikut adalah situs Kost terbaik di kota ambon kecamatan waiheru
						ini adalah kamar kost yang fasilitasnya lumayan lengkap
					</p>
				...
				<div class="booking-form">
					...
					<form method="post" action="user/pemesanan" name="opsi">
						...
						<div class="select-option">
							...
							<select name="tipe" id="kamar" required>
