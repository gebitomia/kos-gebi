                        ...
                        ?>
                            <div class="col-lg-4 col-md-6">
                                <div class="room-item" style="border: 1px solid #e99f55;">
                                    <img src="../simpangambar/<?php echo htmlspecialchars($gambar); ?>" alt="Room Image">
                                    <div class="ri-text">
                                        <h4><?php echo htmlspecialchars($tipe); ?>
                                        ...
                                        <a href="pemesanan.php?id=<?php echo $id; ?>" class="primary-btn">Detail Kamar >></a>
                                    </div>
                                </div>
                            </div>
            <?php
